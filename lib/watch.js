...
var watchThing = (0, _ramda.curry)(function (peer, _ref) {
  var id = _ref.id,
  ...
  if (replyToId) {
    state = (0, _ramda.assocPath)(["things", replyToId, "replies", id], true, state);
  }
...
var watchCollection = exports.watchCollection = (0, _ramda.curry)(function (peer, soul) {
  var state = peer.getState();
  if ((0, _ramda.path)(["collections", soul], state)) return null;
  ...
  var onThing = function onThing(thing) {
    ...
    peer.setState((0, _ramda.assocPath)(["collections", soul, "things", thing.id], true, peer.getState()));

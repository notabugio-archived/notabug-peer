...
var countVotes = exports.countVotes = (0, _ramda.curry)(function (peer, id, kind, data) {
  ...
  peer.setState((0, _ramda.assocPath)(["things", id, "votes", kind], count, state));
...
var watchThing = (0, _ramda.curry)(function (peer, data) {
  ...
  var state = peer.getState();
  if ((0, _ramda.path)(["things", id, "chain"], state)) return;
  ...
  state = (0, _ramda.assocPath)(["things", id], (0, _ramda.merge)((0, _ramda.pathOr)({}, ["things", id], state), { id: id, timestamp: timestamp, lastActive: lastActive, chain: chain, replyToId: replyToId, opId: opId }), state);
...
var watchCollection = exports.watchCollection = (0, _ramda.curry)(function (peer, soul) {
  ...
  var onThing = function onThing(thing) {
    ...
    var state2 = peer.getState();
    peer.setState((0, _ramda.assocPath)(["collections", soul, "things", thing.id], 1, state2));

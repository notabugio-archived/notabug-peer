...
exports.getCollectionsArray = exports.getCollections = exports.getCollection = exports.getScore = exports.getThingData = exports.getOpId = exports.getVoteCount = exports.getLastActive = exports.getTimestamp = undefined;
...
var getThingData = exports.getThingData = function getThingData(peer) {
  return function (id) {
    return (0, _pathOr2.default)(null, ["data", id], peer.getState());
  };
};

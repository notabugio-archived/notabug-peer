...
var putThing = exports.putThing = (0, _ramda.curry)(function (peer, data) {
...
var submit = exports.submit = (0, _ramda.curry)(function (peer, data) {
...
var comment = exports.comment = (0, _ramda.curry)(function (peer, data) {
  var user = peer.isLoggedIn();
...
var chat = exports.chat = (0, _ramda.curry)(function (peer, data) {
  var user = peer.isLoggedIn();
  if (user) {
    data.author = user.alias; // eslint-disable-line
    data.authorId = user.pub; // eslint-disable-line
...
var vote = exports.vote = (0, _ramda.curry)(function (peer, id, kind, nonce) {
...
var indexThing = exports.indexThing = (0, _ramda.curry)(function (peer, thingid, data) {
  ...
  var dayStr = (0, _util.getDayStr)(data.timestamp);
  ...
  thing.get("votesup").once(function () {
    return null;
  });
  thing.get("votesdown").once(function () {
    return null;
  });
  thing.get("allcomments").once(function () {
    return null;
  });
  thing.get("comments").once(function () {
    return null;
  });
  topic.set(thing);
  topicDay.set(thing);

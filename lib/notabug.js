...
var notabug = function notabug() {
  ...
  var _ref = config || {},
      ...
      rest = _objectWithoutProperties(_ref, ["peers", "disableValidation", "blocked", "localStorage", "persist"]);
  ...
  peer.souls = Object.keys(souls).reduce(function (res, key) {
    return (0, _assoc2.default)(key, souls[key](peer), res);
  }, {});

...
var map$1 = function (thingData) {
    return reduce(function (cmdMap, id) {
        ...
        return assocPath(tokenized, timestamp || 0, cmdMap);
    }, {}, keys(thingData));
};
